...
% as Resarch.gov doesn't like it. Likewise, avoid any text containing http, https, mailto, etc.
%
...
%
\setlength{\baselineskip}{12.6pt} % main text
...
\begin{figure}
\centerline{\includegraphics[width=0.6\hsize]{figure-to-insert.pdf}}
